...
public abstract class ListTest {
    ...
    /*
     * Test case 1 for retreat : leftLength = 1, rightLength = 0.
     */
    @Test
    ...
    /*
     * Test case 2 for retreat : leftLength = 5, rightLength = 0.
     */
    @Test
    public final void testRetreatLeftFiveRightEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(5, "yellow", "orange", "green",
                "purple", "pink");
        List<String> list2 = this.createFromArgsRef(4, "yellow", "orange", "green",
                "purple", "pink");
    ...
    /*
     * Test case 3 for retreat : leftLength = 1, rightLength = 1.
     */
    @Test
    ...
    /*
     * Test case 4 for retreat : leftLength = 1, rightLength = 5.
     */
    @Test
    public final void testRetreatLeftOneRightFive() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(1, "yellow", "orange", "green",
                "purple", "pink", "green");
        List<String> list2 = this.createFromArgsRef(0, "yellow", "orange", "green",
                "purple", "pink", "green");
    ...
    /*
     * Test case 5 for retreat : leftLength = 5, rightLength = 1
     */
    @Test
    public final void testRetreatLeftFiveRightOne() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(5, "yellow", "orange", "green",
    ...
    /*
     * Test case 6 for retreat : when leftLength = 5 and rightLength = 1, Calls
     * retreat() twice, expecting leftLength = 3 and rightLength = 3
     */
    @Test
    public final void testRetreatLeftFiveRightOneTwice() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(5, "yellow", "orange", "green",
    ...
    /*
     * Test case 7 for retreat : verifies correct behavior when duplicate
     * elements are present in the list. Retreat should move the cursor without
     * affecting element order.
     */
    @Test
    public final void testRetreatDuplicate() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(4, "a", "a", "b", "b", "c");
        List<String> list2 = this.createFromArgsRef(3, "a", "a", "b", "b", "c");
    ...
    /*
     * Test case 8 for retreat : Retreat repeatedly until start point(leftLength
     * = 0) Start at leftLength = 5 and repeatedly call Retreat until cursor is
     * at the start point.
     */
    @Test
    public final void testRetreatUntilLeftEmpty() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(5, "a", "b", "c", "b", "e");
        List<String> list2 = this.createFromArgsRef(0, "a", "b", "c", "b", "e");
    ...
    /*
     * Test case 8 for retreat & moveToFinish : retreat after moveToFinish
     * leftLength=2,rightLength=2 -> moveToFinish -> leftLength=5,rightLength=0
     * -> retreat -> leftLength=4,rightLength=1
     */
    @Test
    public final void testRetreatAfterMoveToFinish() {
         ...
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "a", "b", "c", "d", "e");
        List<String> list2 = this.createFromArgsRef(4, "a", "b", "c", "d", "e");

        /*
         * Call moveToFinish() first and then retreat() under test
         */
        list1.moveToFinish();
        list1.retreat();
    ...
    /*
     * Test case 9 for Advance & retreat : advance and then retreat within
     * bounds this should be no operation
     */
    @Test
    public final void testAdvanceThenRetreatIsNoOp() {
        /*
         * Set up variables
         */
        List<String> list1 = this.createFromArgsTest(2, "a", "b", "c");
        List<String> list2 = this.createFromArgsRef(2, "a", "b", "c");
        /*
         * Call advance() first and then retreat() under test
         */
        list1.advance();
        list1.retreat();
