...
public class List3<T> extends ListSecondary<T> {
    ...
    private void createNewRep() {
        ...
        // Initialize preStart, postFinish Node
        this.preStart = new Node();
        this.postFinish = new Node();

        // Point lastLeft to preStart
        this.lastLeft = this.preStart;

        this.preStart.next = this.postFinish;
        this.postFinish.previous = this.preStart;

        // Initialize |right| = 0 ,|left| = 0
        this.leftLength = 0;
        this.rightLength = 0;

        // Explicitly set boundaries to avoid relying on default nulls
    ...
    public final void addRightFront(T x) {
        ...
        q.data = x; // insert data into {Node q}

        Node c = this.lastLeft; // Refer cursor Node
        ...
        this.rightLength++; // increase |right| by 1
    ...
    public final T removeRightFront() {
        ...
        // Create node next to lastLeft
        Node q = this.lastLeft.next;
        T data = q.data;

        // Refer Cursor Node
        Node c = this.lastLeft;

        // connect c with q.next
        c.next = q.next;
        q.next.previous = c;
    ...
    public final void advance() {
        ...
        // Move the position of {this.lastLeft}
    ...
    public final void moveToFinish() {
        ...
        // Move the cursor to the previous node of postFinish (ending point)
    ...
    public final void retreat() {
        ...
        // move the cursor to the left side by one
